...
public class SportFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        articles = ((MainActivity)getActivity()).filterArticles("Sports");
        ...
        fb_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                findNavController(fragmentView).navigate(SportFragmentDirections.actionSportToLogIn());
            }
        });
        fb_create.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                findNavController(fragmentView).navigate(SportFragmentDirections.actionSportToEditArticle(-1));
            }
        });
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentView = inflater.inflate(R.layout.fragment_sport, container, false);
        rv = fragmentView.findViewById(R.id.rv_sport);
        return fragmentView;
    }
    ...
    private void showRecyclerView(){
        ...
        adapter = new NewsAdapter(articles, getActivity(), new NewsAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                findNavController(view).navigate(SportFragmentDirections.actionSportToArticleDetail(articles.get(position).getId()));
            }

            @Override
            public void onEditItemClick(View view, int position) {
                findNavController(view).navigate(SportFragmentDirections.actionSportToEditArticle(articles.get(position).getId()));
            }
